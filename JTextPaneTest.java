...
public class JTextPaneTest extends JFrame
{
    ...
    */
    ...
    private void createStyles(JTextPane editor)
    {
        ...
        StyleConstants.setBackground(normal, Color.red); // Цвет фона а как сделать цвет букв от сюда
    ...
    private void loadText(JTextPane editor)
    {
        ...
        for (int i = 0; i < TEXT.length; i++) {
            Style style = (TEXT[i].equals("Testtext")) ? 
                                                   heading : normal;
            insertText(editor, TEXT[i], style);
        }
    ...
    private void changeDocumentStyle(JTextPane editor)
    {
        ...
        StyledDocument doc = editor.getStyledDocument();
        doc.setCharacterAttributes(8, 9, blue, false); // цвет.
    }
    /**
